...
<svelte:head>
	...
	<meta
		name="description"
		content="PyPSA-based optimization for planning renewable capacity — solar, wind, storage — with weather-informed modeling."
	/>
</svelte:head>
...
streamlit run dashboard/app.py</code></pre>
		...
		<div class="flex flex-wrap gap-4">
			...
			{#if primaryImpl?.repoUrl}
				<Button href={primaryImpl.repoUrl} variant="ghost" external>Implementation source</Button>
			{/if}
		</div>
	</div>
</PageSection>
